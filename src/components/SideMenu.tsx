...
//hook useLocation
    return (
        <>
        <nav className="col-span-1 bg-mk-blue rounded-3xl min-w-[300px] h-[100vh] flex flex-col justify-between">
                <div className="mt-7">
                    <div className="flex m-5 mb-7 pb-10 flex-wrap">
                        ...
                        <div className="grid grid-rows-4 items-center mx-8 mt-10 pt-10">
                            {isMK ?
